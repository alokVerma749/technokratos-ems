...
function EventCard({ name, description, noOfMember, venue}) {
 
  return (
    <Card className='shadow-xl rounded w-1/3'>
      ...
      <CardActions>
        ...
        <span class="relative w-full text-left text-indigo-600 transition-colors duration-300 ease-in-out group-hover:text-white">Register Now</span>
      </button>
      </CardActions>
    </Card>
  );
