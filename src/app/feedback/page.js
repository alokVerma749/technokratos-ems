		...
		<fieldset className="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm dark:bg-gray-50">
			...
			<div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
				...
				<div className="col-span-full sm:col-span-3">
					...
					<input id="Mobile Number" type="Mobile Number" placeholder="Mobile Number" className="w-full rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
				</div>
				<div className="col-span-3">
					<label htmlFor="branch" className="text-sm">Branch</label>
					<input id="branch" type="text" placeholder="Branch" className="w-full rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
				</div>
				<div className="col-span-8">
					<label htmlFor="message" className="text-sm">Your message</label>
					<textarea id="message" type="text" placeholder="Write your message for us" className="w-full rounded-md focus:ring focus:ring-opacity-75 dark:text-gray-50 focus:dark:ring-violet-600 dark:border-gray-300" />
				</div>
				<Button variant="contained" style={{background:'#4f46e5'}} startIcon={<SendIcon/>} >Submit</Button>
			</div>
		</fieldset>
